...
/**
 * An object that maps longs to floats. This is a variant of the standard Java
 * {@link Map}, except that the type of the keys is hard coded as long and the
...
public interface MapLF {
	 ...
	 * this is a inefficient operation since it triggers autoboxing of the long
